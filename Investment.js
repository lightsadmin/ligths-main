      ...
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        <View style={styles.banner}>
          <View style={styles.bannerContent}>
            ...
            <Text style={styles.bannerDescription}>
              Track your investments and grow your portfolio for a secure financial future
            </Text>
          </View>
          <View style={styles.bannerIconContainer}>
            <MaterialCommunityIcons name="chart-timeline-variant" size={42} color="#FFFFFF" />
          </View>
        </View>
        ...
        <View style={styles.featuredSection}>
          ...
          <Text style={styles.sectionSubtitle}>
            We're building powerful investment tracking tools to help grow your wealth
          </Text>
          ...
          <View style={styles.timeline}>
            <View style={styles.timelineItem}>
              ...
              <View style={styles.timelineContent}>
                ...
                <Text style={styles.timelineDescription}>Basic tracking and portfolio views</Text>
              </View>
            </View>
            ...
            <View style={styles.timelineItem}>
              ...
              <View style={styles.timelineContent}>
                ...
                <Text style={styles.timelineDescription}>Portfolio analytics and performance tracking</Text>
              </View>
            </View>
            ...
            <View style={styles.timelineItem}>
              ...
              <View style={styles.timelineContent}>
                ...
                <Text style={styles.timelineDescription}>Asset allocation and rebalancing tools</Text>
              </View>
            </View>
          </View>
        </View>
        ...
        <View style={styles.notifySection}>
          <MaterialCommunityIcons name="bell-ring-outline" size={24} color="#2563EB" />
        ...
        <View style={styles.tipsSection}>
          ...
          <View style={styles.tipCard}>
            ...
            <Text style={styles.tipContent}>
              The power of compounding works best over long periods. Starting early, even with small amounts, can lead to significant growth.
            </Text>
          </View>
          ...
          <View style={styles.tipCard}>
            ...
            <Text style={styles.tipContent}>
              Consistent investing through SIPs (Systematic Investment Plans) can help navigate market volatility through rupee-cost averaging.
            </Text>
          </View>
        </View>
      </ScrollView>
